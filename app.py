...
def validate_input(value):
    ...
    if value == "":
        return True
    # Allow the entire value if all characters are allowed
    return all(char in allowed_values for char in value)
    # return value in allowed_values or value == ""
...
Button(
    root, text=",", command=lambda: getOperator("."), bg=btn_bg_dark, fg=font_color
).grid(row=6, column=2, sticky=W + E)

# Numeric Buttons
Button(
    root, text="1", command=lambda: getNumbers(1), bg=btn_bg_dark, fg=font_color
).grid(row=5, column=0, sticky=W + E)
Button(
    root, text="2", command=lambda: getNumbers(2), bg=btn_bg_dark, fg=font_color
).grid(row=5, column=1, sticky=W + E)
Button(
    root, text="3", command=lambda: getNumbers(3), bg=btn_bg_dark, fg=font_color
).grid(row=5, column=2, sticky=W + E)

Button(
    root, text="4", command=lambda: getNumbers(4), bg=btn_bg_dark, fg=font_color
).grid(row=4, column=0, sticky=W + E)
Button(
    root, text="5", command=lambda: getNumbers(5), bg=btn_bg_dark, fg=font_color
).grid(row=4, column=1, sticky=W + E)
Button(
    root, text="6", command=lambda: getNumbers(6), bg=btn_bg_dark, fg=font_color
).grid(row=4, column=2, sticky=W + E)

Button(
    root, text="7", command=lambda: getNumbers(7), bg=btn_bg_dark, fg=font_color
).grid(row=3, column=0, sticky=W + E)
Button(
    root, text="8", command=lambda: getNumbers(8), bg=btn_bg_dark, fg=font_color
).grid(row=3, column=1, sticky=W + E)
Button(
    root, text="9", command=lambda: getNumbers(9), bg=btn_bg_dark, fg=font_color
).grid(row=3, column=2, sticky=W + E)

Button(
    root, text="0", command=lambda: getNumbers(0), bg=btn_bg_dark, fg=font_color
...
Button(root, text="+/-", command=lambda: changeSign()).grid(
    row=6, column=5, sticky=W + E
)
